    ...
    <div className="grid lg:grid-cols-2 gap-12 items-center w-full">
      <div className="space-y-8">
        <div className="space-y-2">
          ...
          <h1 className="text-5xl lg:text-7xl font-extrabold tracking-tight text-white leading-tight">
            {hero.title || "I Architect Robust Backend Systems."}
          </h1>
        </div>
        ...
        <p className="text-xl text-neutral-400 leading-relaxed max-w-xl">
          ...
          .{" "}
          {hero.description ||
            "A Backend Engineer specialized in building high-performance, secure, and scalable APIs using PHP & Laravel."}
        </p>
        ...
        <div className="flex flex-wrap gap-4 pt-4">
          ...
          >
            <span>{hero.ctaButtons?.viewProjects || "View Projects"}</span>
            <svg
          ...
          >
            {hero.ctaButtons?.contactMe || "Contact Me"}
          </button>
        </div>
      ...
      <div className="relative flex justify-center lg:justify-end">
        <div className="relative w-72 h-72 lg:w-96 lg:h-96">
          ...
          <div className="relative z-10 w-full h-full rounded-2xl border border-white/10 overflow-hidden bg-neutral-900 group shadow-2xl">
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent"></div>
            <img
              src={hero.heroImage || "https://picsum.photos/seed/dev/800/800"}
              alt={hero.name}
              className="w-full h-full object-cover grayscale opacity-80 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-700"
            />
            <div className="absolute bottom-6 left-6 right-6 p-4 glass rounded-xl border border-white/5">
              <div className="mono text-[10px] text-indigo-400 mb-1 font-bold">
                CURRENTLY_RUNNING
              </div>
