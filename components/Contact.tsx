    ...
    return (
      <div className="flex justify-center items-center min-h-screen">
        <div className="text-red-400 text-2xl">
          Error loading contact content: {error}
        </div>
      </div>
    );
  }
    ...
    <div className="grid lg:grid-cols-2 gap-16">
      <div>
        ...
        <h3 className="text-4xl font-bold text-white mb-6">
          Ready to scale your next big project?
        </h3>
        <p className="text-neutral-400 leading-relaxed mb-12 max-w-md">
          Whether you need a full system overhaul or a specific API integration,
          I'm here to build high-quality backend solutions that last.{" "}
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <a
                  ...
                  className="text-lg font-bold text-white hover:text-indigo-400 transition-colors"
                >
                  {contact.social_links.github.replace("https://", "")}
                </a>
              </div>
            </div>
          )}
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <a
                  ...
                  className="text-lg font-bold text-white hover:text-indigo-400 transition-colors"
                >
                  {contact.social_links.linkedin.replace("https://", "")}
                </a>
              </div>
            </div>
          )}
      ...
      <div className="glass p-8 rounded-2xl border border-white/10">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            <label className="text-xs font-bold text-neutral-500 uppercase tracking-widest block mono">
              Your_Name
            </label>
            <input
              type="text"
          ...
          <button
            ...
            className="w-full py-4 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-lg transition-all active:scale-[0.98] shadow-lg shadow-indigo-600/20 disabled:opacity-50 disabled:cursor-not-allowed"
          >
