  ...
  return (
    <div>
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
        <div>
          <h2 className="text-xs font-bold text-indigo-500 uppercase tracking-widest mb-4 mono">02 // TECH_STACK</h2>
          <h3 className="text-4xl font-bold text-white">The tools I use to build robust systems.</h3>
        </div>
      ...
      <div className="mt-16 p-8 glass rounded-2xl border border-white/10 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center gap-8 text-center md:text-left">
          <div className="w-16 h-16 rounded-full bg-indigo-600 flex items-center justify-center shrink-0">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-white"><path d="m18 16 4-4-4-4"/><path d="m6 8-4 4 4 4"/><path d="m14.5 4-5 16"/></svg>
          </div>
          <div>
            <h4 className="text-xl font-bold text-white mb-2">Looking for a specific skill?</h4>
            <p className="text-neutral-400 max-w-2xl">
              While my core expertise is PHP & Laravel, I am highly adaptable and have worked with 
              various technologies including Python (FastAPI), Node.js, and Infrastructure as Code (Terraform).
            </p>
          </div>
        </div>
      </div>
